                ...
                <form action="{{ route('products.add') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row my-3">
                        ...
                        <div class="col-md-2 p-2">
                            ...
                            <input name="price" value="{{ old('price') }}" type="number" step=".01"
                        ...
                        <div class="col-md-2 p-2">
                            ...
                            <input name="discount" value="{{ old('discount', 0) }}" type="number"
                        ...
                        <div class="col-md-2 p-2">
                            ...
                            <input name="stock" value="{{ old('stock', 100) }}" type="number"
                    ...
                    <div class="row my-3">
                        <div class="col-md-6">
                            ...
                            <textarea name="excerpt" class="form-control @error('excerpt') is-invalid @enderror"
                                id="excerpt" rows="5">{{ old('excerpt') }}</textarea>
                            @error('excerpt')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="presentation" class="form-control @error('presentation') is-invalid @enderror"
                                id="presentation" rows="5">{{ old('presentation') }}</textarea>
                            @error('presentation')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row my-3 d-flex align-items-end">
                        <div class="col-md-4">
                            <div id="img-preview">
                                <img id="photo-preview" src="/content/products/product.jpg" alt=""
                        ...
                        <div class="col-md-2">
                            ...
                            <input name="position" type="number" value="{{ old('position', 10) }}"
                        ...
                        <div class="col-md-2">
                            ...
                            <input name="views" type="number" value="{{ old('views', 100) }}"
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12">
                            <a href="{{ route('products.list') }}" class="btn btn-dark float-start" type="submit">
