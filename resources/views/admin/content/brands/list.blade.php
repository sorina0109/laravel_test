                                ...
                                <tr>
                                    ...
                                    <td style="width: 100px;">
                                        ...
                                        <button class="btn btn-danger btn-circle btn-sm"
                                            title="Sterge brandul din baza de date"
                                            onclick="if(confirm('Confirmati stergerea brandului {{ $brand->title }}?'))
                                                    {
                                                         document.getElementById('form-delete-{{ $brand->id }}').submit();
                                                     }">
                                       ...
                                       {{-- <button class="btn btn-danger btn-sm btn-circle" onclick="">
                                        ...
                                        <ahref="route('brands.photos',$brand->id)}}" title="adauga galerie foto"
