...
@section('content')
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Editare Categorie: <span class="text-info">{{ $category->name }}</span> id - <span
                    class="text-danger">{{ $category->id }}</span> - Sectiune <span
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item active">Editeaza Categorie
                    <span class="text-info">{{ $category->name }}</span>
                </li>
                <li class="breadcrumb-item"><a href="{{ route('categories.photos', $category->id) }}>Galerie foto</a>
                </li>
            </ol>
                    ...
                    <div class="row my-3">
                        <div class="col-md-3">
                            ...
                            <input onblur="setSlug()" type="text" name="name" required
                                ...
                                value="{{ old('name', $category->name) }}" placeholder="Introduceti numele categoriei">
                            @error('name')
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="slug" required class="form-control @error('slug') is-invalid @enderror"
                                ...
                                placeholder="Slug trebuie sa fie unic">
                            @error('slug')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" required name="title"
                                ...
                                value="{{ old('title', $category->title) }}" placeholder="Descriere scurta categorie">
                            @error('title')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-1 align-bottom">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="promo" id="promo1" value="0"
                                    {{ old('promo', $category->promo) === 0 ? 'checked' : '' }}
                                    @if (is_null(old('promo', $category->promo))) checked @endif>
                                <label class="form-check-label" for="active1">
                                    Standard
                                </label>
                            </div>
                    ...
                    <div class="row my-3">
                        <div class="col-md-6">
                            ...
                            <div class="custom-file">
                                <label for="photoFile" class="form-label">Selectati fotografia categoriei</label>
