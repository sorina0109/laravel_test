...
@section('content')
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Edit section: <span class="text-info">{{ $section->name }}</span>
                id: <span class="text-danger">{{ $section->id }}</span>
            </h1>
                ...
                <form action="{{ route('sections.update', $section->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input onblur="setSlug()" name="name" value="{{ old('name', $section->name) }}" type="text"
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="description" value="{{ old('description', $section->description) }}" type="text"
                    ...
                    <div class="row mt-3 d-flex align-items-end">
                        <div class="col-md-4">
                            <div id="img-preview">
                                <img id="photo-preview" src="{{ $section->photoUrl() }}" alt=""
                        ...
                        <div class="col-md-2 align-bottom">
                            ...
                            <input name="position" type="number" value="{{ old('position', $section->position) }}"
                        ...
                        <div class="col-md-2 align-bottom">
                            <label for="icon" class="form-label">
                                <i class="mr-1 {{ isset($section->icon) ? $section->icon : 'fas fa-th-list' }}"></i>
                                Icon (font-awesome)
                            </label>
                            <input name="icon" type="text" class="form-control @error('icon') is-invalid @enderror"
                                id="icon" value="{{ old('icon', $section->icon) }}">
                        ...
                        <div class="col-md-2 align-bottom">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" value="1" name="active" id="active1"
                                    {{ old('active', $section->active) == 1 ? 'checked' : '' }} @if (is_null(old('active'))) checked @endif>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="active" id="active2" value="0"
                                    {{ old('active', $section->active) === 0 ? 'checked' : '' }}>
                        ...
                        <div class="col-md-2 align-bottom">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="promo" id="promo1" value="0"
                                    {{ old('promo', $section->promo) === 0 ? 'checked' : '' }} @if (is_null(old('promo', $section->promo))) checked @endif>
                                <label class="form-check-label" for="active1">
                                    Standard
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="promo" id="promo2" value="1"
                                    {{ old('promo', $section->promo) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="row mt-5 p-3 bg-light">
                            ...
                            <div class="col-md-4">
                                ...
                                <input name="meta_description" type="text"
                                    ...
                                    id="meta_description"
                                    value="{{ old('meta_description', $section->meta_description) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input name="meta_keywords" type="text"
                                    class="form-control @error('meta_keywords', $section->meta_keywords) is-invalid @enderror"
                                    id="meta_keywords" value="{{ old('meta_keywords', $section->meta_keywords) }}">
                                @error('meta_keywords')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
