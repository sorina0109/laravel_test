...
class ProductsController extends Controller
{
    ...
    public function deleteCategory($id)
    {
        ...
        if (!($product->photo == 'product.jpg')) {
            File::delete('content/products/' . $product->photo);
        }

        //$product->pages()->detach();

        $product->delete();
        return redirect(route('product.list'))->with('success', 'produsul ' . $product->name . ' a fost sters definitiv din baza de date');
    }
