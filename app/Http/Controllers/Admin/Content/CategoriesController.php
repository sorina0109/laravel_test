...
use App\Http\Requests\CategoriesMagAddRequest;
...
class CategoriesController extends Controller
{
    ...
    public function addCategory(CategoriesMagAddRequest $request, $id)
    {
        $request->validate([
    ...
    public function updateCategory(CategoriesMagAddRequest $request, $id)
    {
        $category = Category::findOrFail($id);
    ...
    //public function photosCategoryMag($id)
    //{
    //    $category = CategoryMag::findOrFail($id);
