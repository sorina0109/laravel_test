...
@section('meta_title', 'Omiro Tools | Contact')
    ...
    <section>
        <div class="container-fluid bg-dark mb-2 pt-5" style="min-height: 150px;">
            <div class="d-flex flex-column align-items-center justify-content-center" >
                <h2 class="font-weight-semi-bold text-center text-light text-uppercase mb-3 mt-3">Contact</h2>

                <div class="d-inline-flex text-light mb-3  font-weight-semi-bold">
                    <p class="m-0"><a class="text-light 55" href="{{ route('home') }}">Acasa</a></p>
                    <p class="m-0 px-2"> - </p>

                    <p class="m-0"> <span class="text-warning">Contact</span></p>
                </div>
